...
- **ExecSummary:** every Frame key question answered (or explicitly marked "pending new research module" where the data does not exist — currently Q2, Q4 and Q6), each answer cited; thesis score 0–100 with rationale; closed-book (its self-checks).
