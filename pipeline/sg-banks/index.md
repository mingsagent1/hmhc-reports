...
> **Project:** Singapore Bank Stock Accumulation Strategy · **Index updated:** 2026-07-21 SGT (provenance-header patch)
...
|---|---|---|---|---|
| **Frame** | *(human-owned guide — no module)* | human authorship | `guides/frame.md` | **Human-authored final installed 2026-07-21** — capital-attraction thesis, 7 key questions (A–D; Q4+Q6 merged same day), decision rule |
